...
// Modified to make bp_code optional since it's generated by a database trigger
export type BusinessPartnerInput = Omit<BusinessPartner, 'id' | 'created_at' | 'updated_at'> & {
  bp_code?: string; // Make bp_code optional for insertion since it's auto-generated
};
